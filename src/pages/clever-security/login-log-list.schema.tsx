...
import { userLogin } from "@/pages/clever-security/enum-data";
...
function detailsDialog() {
  return {
    ...
    dialog: {
      ...
      body: {
        type: "service",
        api: { method: "get", url: apiPath.UserLoginLogController.pageQuery, data: { id: "${id}" } },
        body: {
          type: "tabs",
          mode: "radio",
          tabs: [
            {
              ...
              body: {
                ...
                controls: [
                  ...
                  { name: "loginType", label: "登录方式", type: "static-mapping", map: enum2object(userLogin.type) },
                  { name: "loginState", label: "登录状态", type: "static-mapping", map: enum2object(userLogin.state) },
  ...
  body: [
    {
      ...
      filter: {
        ...
        controls: [
          ...
          { type: "select", label: "渠道", name: "loginChannel", clearable: true, options: userLogin.channel },
          { type: "select", label: "方式", name: "loginType", clearable: true, options: userLogin.type },
          { type: "select", label: "状态", name: "loginState", clearable: true, options: userLogin.state },
      ...
      columns: [
        ...
        { name: "loginType", label: "登录方式", sortable: true, type: "mapping", map: enum2object(userLogin.type) },
        { name: "loginState", label: "登录状态", sortable: true, type: "mapping", map: enum2object(userLogin.state) },
